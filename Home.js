...
<div className='text-center mt-10 mb-10 p-5'style= {{backgroundColor : '#F4FCFC' }}>
    ...
    <div className='d-flex justify-content-evenly container  mt-5 mb-5 p-5' >
    ...
    <div className='homedivisiontwo p-5 mb-10'>
      <h3 className='text-center-underline mt-10 mb-10 p-5'></h3>
    ...
    <div className='text-center  mt-10 mb-10 p-5'style= {{backgroundColor : '#E4F3FB  ' }}>
    <h1><font size='+80'><font face='lucida'><font color='#050505 '>OUR PROJECTS</font></font></font></h1>
    <p><font color='#050505 '>AWESOME PRODUCTS</font></p>

      <div className='d-flex justify-content-evenly container  mt-3 mb-3 p-3' >
        <div className='d-flex justify-content-evenly containertext-center ' style = {{width : "30%"}} >
           <img height='600' width='650' src={that1}/><img height='600' width='650' src={that2}/><img height='600' width='650'src={that3}/>
        </div>
      </div>
      <div className='text-center  mt-10 mb-10 p-5'style= {{backgroundColor : '#E4F3FB  ' }}>
