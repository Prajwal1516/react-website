...
function Service() {
  return (
    <div>
     ...
     <div className='text-center mt-10 mb-10 p-5'style= {{backgroundColor : '#F4FCFC' }}>
         ...
         <p><font color='#080808 '>100% SATISFACTION GUARANTEED !</font></p>
          ...
          <div className='d-flex justify-content-evenly container text-center mt-10 mb-10 p-5' style = {{width : "30%"}} >
          ...
          <div className='d-flex justify-content-evenly container text-center mt-5 mb-5 p-5' style = {{width : "80%"}} >
          ...
          <div className='d-flex justify-content-evenly container text-center mt-5 mb-5 p-5' style = {{width : "30%"}} >
    ...
    <div className='text-dark text-center mt-10 mb-10 p-5' style={{backgroundColor : '#E4F3FB'}}>
